...
$stmt = $conn->prepare("
    SELECT a.status, j.title, j.location, j.job_date, j.allowance, COALESCE(a.paid_amount,j.allowance_amount,0) AS amount
    FROM applications a
                ...
                <?php foreach ($applications as $application): ?>
                    <div class="application-card">
                        <div>
                            ...
                            <p>Date : <?php echo e($application["job_date"]); ?> | Allowance : <?php echo e($application["allowance"]); ?></p>
                        </div>
