    ...
    <section class="right-section">
      <form class="login-box register-box" id="registerForm" action="register-student.php" method="POST" autocomplete="off">
        ...
        <div class="input-group">
          ...
          <select id="status_category" name="status_category" required>
            <option value="">Choose Status</option>
            <?php foreach (["B40", "M40", "T20"] as $statusOption): ?>
              <option value="<?php echo e($statusOption); ?>" <?php echo $values["status_category"] === $statusOption ? "selected" : ""; ?>><?php echo e($statusOption); ?></option>
            <?php endforeach; ?>
          </select>
        </div>
